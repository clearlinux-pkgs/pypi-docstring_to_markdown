...
Source0  : https://files.pythonhosted.org/packages/58/1f/16e6d4026e94224d662dcd344dcd3563bc8a74a272f2c27b325793cad5fc/docstring_to_markdown-0.16.tar.gz
...
%prep
%setup -q -n docstring_to_markdown-0.16
cd %{_builddir}/docstring_to_markdown-0.16
pushd ..
cp -a docstring_to_markdown-0.16 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742922010
