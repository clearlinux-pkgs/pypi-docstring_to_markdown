...
Source0  : https://files.pythonhosted.org/packages/52/c2/6f73c08b97bacd1242835bdca1cfc123b059eb15af9350eb1eb5d58868fc/docstring-to-markdown-0.12.tar.gz
...
%prep
%setup -q -n docstring-to-markdown-0.12
cd %{_builddir}/docstring-to-markdown-0.12
pushd ..
cp -a docstring-to-markdown-0.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679499332
